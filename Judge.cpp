...
void Judge::setHandInfo(const HandInfoType info1, const HandInfoType info2) {
	try {
		player1 = new HandInfoType;
		*player1 = info1;

		player2 = new HandInfoType;
		*player2 = info2;
